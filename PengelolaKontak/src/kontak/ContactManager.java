...
public class ContactManager extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, new java.awt.Color(153, 255, 153), null, null));
        ...
        tfnama.setFont(new java.awt.Font("Bahnschrift", 0, 14)); // NOI18N

        l2.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 14)); // NOI18N
        l2.setText("No. Telp");

        tfno.setFont(new java.awt.Font("Bahnschrift", 0, 14)); // NOI18N
        ...
        l3.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 14)); // NOI18N
        l3.setText("Kategori");

        cb1.setFont(new java.awt.Font("Baskerville Old Face", 3, 14)); // NOI18N
        cb1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Keluarga", "Teman", "Rekan Kerja" }));

        btnsimpan.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        btnsimpan.setText("SIMPAN");
        btnsimpan.setPreferredSize(new java.awt.Dimension(145, 27));
        ...
        btncari.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        ...
        l1.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 14)); // NOI18N
        l1.setText("Nama");

        EditContactBtn.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        ...
        DelContactBtn.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        DelContactBtn.setText("HAPUS");
        ...
        jList.setFont(new java.awt.Font("Bahnschrift", 0, 12)); // NOI18N
        ...
        l4.setFont(new java.awt.Font("Berlin Sans FB Demi", 1, 14)); // NOI18N
        l4.setText("Daftar Nama Kontak");

        btnbersih.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        ...
        btnekspor.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
        ...
        btnimpor.setFont(new java.awt.Font("Bell MT", 1, 14)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(11, 11, 11))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addComponent(btnimpor, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnekspor, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(l3))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnbersih, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnekspor, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnimpor, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    if (!evt.getValueIsAdjusting()) { // Memastikan hanya saat perubahan akhir
            String namaKontak = jList.getSelectedValue();
            if (namaKontak != null) {
    ...
    if (evt.getClickCount() == 1) { // Jika baris diklik dua kali
                int selectedRow = jTable.getSelectedRow(); // Ambil indeks baris yang dipilih
                if (selectedRow != -1) { // Pastikan ada baris yang dipilih
                    String nama = jTable.getValueAt(selectedRow, 1).toString(); // Ambil nama dari kolom kedua
    ...
    private void addContact() {
        ...
        String kategori = (String) cb1.getSelectedItem();  // Ambil kategori
    ...
    private void editContact() {
        ...
        int id = (int) jTable.getValueAt(selectedRow, 0); // Misalkan kolom ID ada di index 0

        // Cek jika nomor telepon baru sudah ada di kontak lain, kecuali kontak yang sedang diedit
        if (isNomorHpExists(nomor) && !nomor.equals(jTable.getValueAt(selectedRow, 2))) { // Asumsikan nomor telepon ada di kolom index 2
    ...
    private void loadContactData(String nama) { //ambil data dari db, masukkan ke form saat list nama kontak dipilih
        try (Connection conn = DatabaseHelper.getConnection();
            ...
            if (rs.next()) {
                ...
                // Set data ke form
                tfnama.setText(nama);
                tfno.setText(nomorTelepon);
                cb1.setSelectedItem(kategori); // Jika contCategory adalah JComboBox
            }
        } catch (SQLException e) {
            // Cetak stack trace jika terjadi error
    ...
    private void clearForm() {
        ...
        tfnama.setText("");
        tfno.setText("");
        cb1.setSelectedIndex(0); // Reset ke item pertama

        // Reset JList dan JTable untuk tidak ada yang dipilih
        jTable.clearSelection(); // Tidak ada yang dipilih di JTable
        jList.clearSelection(); // Tidak ada yang dipilih di JList
